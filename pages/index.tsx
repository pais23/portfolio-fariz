...
import pt1 from '../public/easset/e-asset.png';
...
export default function Home() {
  ...
  const projectImages = [pt1, pt2, pt3, pt4, pt5, pt6];

  const projectDescriptionHeaders = [
    "E-ASSET",
    "TNDE (Tata Naskah Dinas Elektronik)",
    "CRMS (City Road Management System)",
    "E-Bidding",
    "SIMKEU (Sistem Informasi  Keuangan)",
    // "Inventory",
    "Kliq (Multiplatform Social Media)."
  ];

  const projectDescriptions = [
    "Ini adalah deskripsi untuk proyek pertama.",
    "Ini adalah deskripsi untuk proyek kedua.",
    "Ini adalah deskripsi untuk proyek ketiga.",
    "Ini adalah deskripsi untuk proyek keempat.",
    "Ini adalah deskripsi untuk proyek kelima.",
    "Ini adalah deskripsi untuk proyek keenam.",
    "Ini adalah deskripsi untuk proyek ketujuh."
  ];

  const openModal = (imageSrc, descriptionHeader, description) => {
    setSelectedImage({src: imageSrc, descriptionHeader: descriptionHeader, description: description});
    setModalOpen(true);
  };
      ...
      <main className='bg-white px-10 md:px-20 lg:px-40 dark:bg-gray-900'> 
        <section>
          <nav className="py-10 mb-1 flex justify-between">
            <h1 className='text-xl font-burtons  text-gray-800 dark:text-white'>Personal Portfolio</h1>
            <ul className='flex items-center'>
              <li>
                <BsFillMoonStarsFill onClick={() => setDarkMode(!darkMode)} className='cursor-pointer text-2xl  text-gray-800 dark:text-white'/>
              </li>
              <li><a className='bg-gradient-to-r from-cyan-500 to-teal-500 text-white px-4 py-2 rounded-md ml-8' href="https://drive.google.com/file/d/1TUwjNkLL_JQiP-5ewy5fdWTiALm9t9x9/view?usp=sharing" target="_blank">Resume</a></li>
            </ul>
          </nav>
          ...
          <div className='text-center p-5'>
            ...
            <h3 className='text-2xl py-2 md-text-3xl  text-gray-800 dark:text-white'>Web & Android Developer</h3>
            <p className='text-md py-2 leading-8 text-gray-800 md:text-xl max-w-2xl mx-auto dark:text-gray-200'>
              ...
              selama 3 tahun dan menyukai dunia pemrograman. Mari mengenal lebih lanjut tentang saya dibawah ini!
            </p>
          </div>
        ...
        <section>
          <div>
            <h3 className='text-3xl py-5 mt-10 text-center  text-gray-800 dark:text-white'>Kemampuan Saya</h3>
            <p className='text-md py-2 leading-8 text-center max-w-4xl mx-auto text-gray-800 dark:text-white'>
              Selama saya bekerja selama 3 tahun, saya telah bekerja sama dengan beberapa <span className='text-teal-500'>  instansi pemerintahan </span> 
          ...
          <div className='lg:flex gap-10'>
            <div className='text-center shadow-lg p-10 rounded-xl my-10 dark:bg-white'>
              ...
              <h3 className='text-lg font-medium pt-8 pb-2 text-gray-800'>Website</h3>
            ...
            <div className='text-center shadow-lg p-10 rounded-xl my-10 dark:bg-white'>
              ...
              <h3 className='text-lg font-medium pt-8 pb-2 text-gray-800'>Aplikasi Android</h3>
              <p className='py-2 text-gray-800'>
        ...
        <section>
          <div>
            <h3 className='text-3xl py-1 text-center  text-gray-800 dark:text-white'>Portofolio</h3>
            <p className='text-md py-2 leading-8 text-center text-gray-800 dark:text-white'>
          ...
          <div className='flex flex-col gap-10 py-10 lg:flex-row lg:flex-wrap'>
            {projectImages.map((imageSrc, index) => (
              <div key={index} className='basis-1/3 flex-1'>
                <button onClick={() => openModal(imageSrc, projectDescriptionHeaders[index], projectDescriptions[index])}>
                  <Image src={imageSrc} alt={`project${index + 1}`} className='rounded-lg object-cover' width={100} height={100} layout="responsive" />
                </button>
              </div>
            ))}
          </div>
        ...
        {modalOpen && (
          <div className='fixed top-0 left-0 w-full h-full flex items-center justify-center bg-black bg-opacity-50'>
            <div className='bg-white p-4 rounded-lg' style={{ width: 'auto', height: 'auto', margin: 'auto' }}>
              <button className='absolute top-4 right-4 text-gray-800 text-5xl' onClick={closeModal}>
                <AiFillCloseCircle />
              </button>
              <div className="flex justify-center items-center flex-col">
                <h3 className="text-center text-2xl mt-4 mb-4 text-gray-800"><b>{selectedImage.descriptionHeader}</b></h3>
                <Image src={selectedImage.src} alt='modal-image' width={750} height={400} className='rounded-lg object-cover' />
                <p className="text-center mt-4 mb-4 text-gray-800">{selectedImage.description}</p>
              </div>
            </div>
          </div>
        )}
